...
public class DiceService {
	...
	public ResponseEntity<String> updateName(String playerName,String newName){
		...
		Optional<Player> optionalPlayer=playerDAO.findByName(playerName);
			...
			if(optionalPlayer.isPresent()) {
				...
				return ResponseEntity.ok("New name: " + newName+" Incorporated");
			}
	...
	public ResponseEntity<String> createDiceThrow(String playerId){
		...
		if(optionalPlayer.isPresent()) {
				...
				diceThrow.setPlayerid(player1.getId());
				diceThrow.setDate_throw(new Date());
			...
			return ResponseEntity.ok(" playerId: "+ playerId+" not Found");
		}
	}
	//DELETE /players/{id}/games: elimina les tirades del jugador 
	
	public ResponseEntity<String> deleteThrows(String playerId){
	...
	public ResponseEntity<List<String>> playersList(){
		...
		List<String>lista=playerDAO.findAll().stream()
				.flatMap(s-> Stream.of("Player: "+s.getName()+" Victories: "+s.getPercent()+"% Id"+s.getId()))
	...
	public ResponseEntity<List<DiceThrow>> throwsList(String playerId){
	...
	public ResponseEntity<Player> playerDetail(String playerId){
