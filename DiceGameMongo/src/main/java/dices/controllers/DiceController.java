...
public class DiceController {
	...
	//PUT /players : modifica el nom del jugador 
	@PutMapping("updateName/{playerName}/{newName}")
	public ResponseEntity<String> updateName(@PathVariable("playerName") String playerName,@PathVariable("newName") String newName){
		
		return diceService.updateName(playerName, newName);
	}

	//POST /players/{id}/games/ : un jugador específic realitza una tirada  dels daus.
	@PostMapping("DiceThrow/{playerId}")
	public ResponseEntity<String> createDiceThrow(@PathVariable("playerId") String playerId){
		
		return diceService.createDiceThrow(playerId);
	}
	//DELETE /players/{id}/games: elimina les tirades del jugador 
	@DeleteMapping("deleteThrows/{playerId}")
	public ResponseEntity<String> deleteThrows(@PathVariable(name="playerId") String playerId){
	...
	public ResponseEntity<List<DiceThrow>> throwsList(@PathVariable("playerId") String playerId){
	...
	public ResponseEntity<Player> playerDetail(@PathVariable("playerId") String playerId){
		
		return diceService.playerDetail(playerId);		
	}
